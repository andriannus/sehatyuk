	...
	<div class="modal" :class="{ 'is-active': visibleModal }">
		...
		<div class="modal-card">
			<header class="modal-card-head">
				<p class="modal-card-title">Detail RS Khusus</p>
				<button class="delete" aria-label="close" @click="switchModal"></button>
			</header>

			<!-- Memuat Detail RS Khusus -->
			<section class="modal-card-body has-text-centered" v-if="loadingRsk">
				<i class="fas fa-spin fa-spinner title"></i>
				<p class="subtitle">Memuat data...</p>
			</section>
			<!-- Akhir Memuat Detail RS Khusus -->

			<section class="modal-card-body" v-if="!loadingRsk">
				<div class="field">
